...
pdf.setTitle('Pension Investment Integrity Act | September 15, 2026')
...
pdf.setFillColor(HexColor('#bde0c2'));pdf.setFont('Mono',8.5);pdf.drawString(38,762,'ARKANSANS FOR PENSION INTEGRITY  /  SEPTEMBER 15, 2026')
...
y-=6
y=para('DRAFTING AND LEGISLATIVE REQUEST',38,y,536,'h2')-8
y=para('Intended pension-plan coverage includes ATRS, APERS, ASHERS, ASPRS, AJRS and LOPFI. Define responsibility and publication triggers for delegated managers and pooled vehicles in drafting. Staff or an independent adviser may prepare the financial work; trustees retain the investment decision.',38,y,536)-8
y=para('Help develop the proposal and consider sponsorship. It is a campaign proposal in development. Request the source and drafting briefing at <b>info@arpensions.org</b>. Read the full proposal and official legislative calendar at <b>arpensions.org/the-act/</b>.',38,y,536)-14
...
pdf.setFont('Mono',7.5);pdf.setFillColor(muted);pdf.drawString(38,25,'ARPENSIONS.ORG  |  CURRENT BRIEF  |  REVIEWED 2026-09-15')
pdf.linkURL('https://arpensions.org/the-act/',(38,20,350,36),relative=0)
pdf.showPage();pdf.save()
(docs/'legislator-letter-2026-09-15.txt').write_text(campaign['letter']+'\n',encoding='utf-8',newline='\n')
outputs=[docs/f'pension-investment-integrity-act-brief-{campaign["date"]}.pdf',docs/'legislator-letter-2026-09-15.txt',images/'campaign-qr.png',images/'og-rebuild.png',ROOT/'src/data/social-cards.json']+list(card_dir.glob('*.png'))
